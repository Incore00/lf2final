...
class leather_tools(tk.Frame):
    def __init__(self, parent, queue, *args, **kwargs):
        ...
        self.edit_slider = ctk.CTkSwitch(self, width=100, height=50, text='Edycja', text_font=('OpenSans.ttf',18))
        self.edit_slider.grid(column=1, row=1, padx=2, pady=2)
        ...
        self.back_btn.grid(column=2, row=1, padx=2, pady=2, sticky='nsew')
        ...
        self.add_flaw_btn.grid(column=3, row=1, padx=2, pady=2, sticky='nsew')
        ...
        self.layer_btn.grid(column=4, row=1, padx=2, pady=2, sticky='nsew')
        ...
        self.move_flaw_btn.grid(column=5, row=1, padx=2, pady=2, sticky='nsew')

        self.resize_flaw_icon = icon_to_image("expand-alt", fill='#c7c6c5', scale_to_width=40)
        self.resize_flaw_btn = ctk.CTkButton(self, image=self.resize_flaw_icon, fg_color='#505050', hover_color='#404040',
                                           compound='left', corner_radius=10, text='Skaluj skazę',
                                           text_font=('OpenSans.ttf', 18))
        self.resize_flaw_btn.grid(column=6, row=1, padx=2, pady=2, sticky='nsew')
        ...
        self.delete_btn = ctk.CTkButton(self, image=self.delete_icon, fg_color='#505050', hover_color='#404040',
                                       ...
                                       text_font=('OpenSans.ttf', 18))
        self.delete_btn.grid(column=7, row=1, padx=2, pady=2, sticky='nsew')
